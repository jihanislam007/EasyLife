            ...
            public void onClick(View v) {
                ...
                if (identityValue == 12) {
                    ...
                    if (one.equals("")) {
                        ...
                        smsIntent.setType("vnd.android-dir/mms-sms");
                        smsIntent.putExtra("address", one + ";" + two + ";" + three + ";" + four + ";" + five + ";" + six + ";" + seven + ";" + eight + ";" + nine + ";" + ten);
                        smsIntent.putExtra("sms_body", "সালাম নিবেন। র\u200C্যাপিড পিআর থেকে আপনার জন্য উপহার হিসাবে একটি ডায়েরি পাঠাতে চাই। বিস্তারিত ঠিকানা করার অনুরুধ করছি। \n" +
                                "শুভেচ্ছান্তে\n" +
                                "শহীদুল ইসলাম শেখর\n" +
                                "ব্যবস্থাপনা পরিচালক \n" +
